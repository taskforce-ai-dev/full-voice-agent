"""
knowledge_base.py -- Optimized RAG / Knowledge-Base module for the Hutch Voice Agent (Selina).

Provides semantic search over Hutch plan/service documentation using ChromaDB
...
if __name__ == "__main__":
    ...
    add_document(
        "Hutch offers a wide range of prepaid and postpaid mobile data, "
        "voice and SMS plans across Sri Lanka with island-wide 4G coverage. "
        "Customers can manage their account via the Hutch Self-Care App.",
        metadata={"source": "self-test"},
    )

    # Run a few sample queries
    sample_queries = [
        "What plans does Hutch offer?",
        "How can I contact Hutch customer service?",
        "Tell me about Hutch 15.",
    ]
