...
def test_property_minimal_rental():
    p = Property(
        ...
        description="Star Properties has a 3-bedroom apartment for rent in Colombo 3.",
    )
    assert p.zone == 3
...
def test_property_rent_on_request_allows_null_amount():
    p = Property(
        ...
        description="Star Properties has a 3-bedroom apartment for rent in Colombo 5.",
    )
