...
def fixture_templates(root: Path) -> TemplateAllowlist:
    ...
    templates = {
        ...
        "runtime/website_demo.py.tmpl": "ROUTES = ('/api/voice-token', '/voice/demo-incoming', '/ws/v1/website-demo/conversation')\n",
        "runtime/website_demo_core.py.tmpl": "class SessionTickets: pass\n",
...
""",
        ...
        "infrastructure/nginx-website-demo.conf.tmpl": "location /voice/demo-incoming {}\n",
