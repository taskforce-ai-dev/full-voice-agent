...
def fixture_templates(root: Path) -> TemplateAllowlist:
    ...
    templates = {
        ...
        "runtime/provider_stt.py.tmpl": "def build_stt_adapter(*_args): return object()\n",
        "runtime/provider_llm.py.tmpl": "def build_llm_adapter(*_args): return object()\n",
        "runtime/provider_tts.py.tmpl": "def build_tts_adapter(*_args): return object()\n",
