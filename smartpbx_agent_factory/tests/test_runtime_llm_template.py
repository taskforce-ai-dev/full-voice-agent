...
def test_candidate_llm_template_keeps_streaming_and_safety_boundaries_explicit() -> None:
    ...
    assert "from provider_adapters import (" in source
    for shared_event in ("ProvisionalSentence", "GenerationFence", "TerminalCommit", "RecoveryBoundary"):
        assert shared_event in source
