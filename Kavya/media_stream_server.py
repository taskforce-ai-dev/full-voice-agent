"""
media_stream_server.py — Multilingual Kavya server using Twilio Media Streams.
...
class MediaStreamSession:
    ...
    def _on_stt_result(self, transcript: str):
        ...
        if self._is_speaking:
            # Kavya is speaking — this is likely telephony echo, not the user.
...
app = FastAPI(
    title="Kavya — Media Streams (Multilingual)",
    version="2.0.0",
    lifespan=lifespan,
)
