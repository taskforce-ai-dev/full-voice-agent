...
def _build_system_prompt(lang: str = "en") -> str:
    ...
    return (
        ...
        "sitting where a name should be ('cha', 'car'); contains stray "
        ...
        "exactly ONE part.\n"
        "    * LOOP EXIT: if after TWO attempts on the same part the "
        "transcriptions still disagree or the guest still says no, do NOT "
        "ask again. Read back your single best guess of the whole name "
        "once, and whatever the answer, say: 'Thank you — I'll note it "
        "down, and our reservations team will confirm the exact spelling "
        "with you on WhatsApp together with your booking confirmation.' "
        "Then proceed to the mobile number. A booking with a best-effort "
        "name plus a follow-up is better than trapping the guest in a "
        "repeat loop.\n"
        ...
        "    * If you STILL cannot make out the name after they have already "
        "said it again once, politely ask them to spell it, e.g. 'Could you "
