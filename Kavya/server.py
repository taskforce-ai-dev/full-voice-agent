...
def _build_system_prompt(lang: str = "en") -> str:
    ...
    return (
        ...
        "confirmed.\n"
        "- Once you have captured both the first name and last name, ask the "
        "guest to spell their name out for you: 'Thank you. Could you please "
        "spell your name for me as well?' Wait for the guest to finish "
        "spelling before continuing. Use the spelling as the authoritative "
        "version of the name — if it differs from what you originally heard "
        "(e.g. you heard 'Jon' but they spell 'J-O-H-N'), silently correct "
        "the captured name to match the spelling rather than re-asking or "
        "flagging the discrepancy. Do NOT proceed to the mobile number, do "
        "NOT read back the booking summary, and do NOT call create_booking "
        "until the guest has spelled their name for you.\n"
