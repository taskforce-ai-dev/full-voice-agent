...
def _build_system_prompt(lang: str = "en") -> str:
    ...
    return (
        ...
        "back your single best guess of the whole name once, and whatever "
        "the answer, say: 'Thank you — I'll note it down, and our "
        "reservations team will confirm the exact spelling with you on "
        "WhatsApp together with your booking confirmation.' "
        ...
        "    * If you STILL cannot make out the name after the repeat "
        "attempts described above have not resolved it, politely ask them "
