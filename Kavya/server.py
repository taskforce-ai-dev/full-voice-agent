...
def _build_system_prompt(lang: str = "en") -> str:
    ...
    return (
        ...
        "    * If you heard only ONE name token (e.g. just 'Fernando'), you "
        "do NOT know whether that is the first name or the last name. Ask: "
        "'Hello, I couldn't hear your first name, can you repeat it again?' "
        "Then once you have the first name, ask: 'And could you repeat your "
        "last name as well?'\n"
        "    * If you heard what sounds like only a first name and no "
        "surname, say: 'Hello, I couldn't hear your last name, can you "
        "repeat it again?'\n"
        "    * If you heard what sounds like only a surname with no first "
        ...
        "confirmed.\n"
        "- Once you have captured both the first name and last name, judge "
        "how confident you are that you heard them correctly. If you are NOT "
        "confident — the audio was unclear, the name is unusual, or it could "
        "plausibly be heard more than one way — read the full name back and "
        "ask for a yes/no confirmation before continuing, e.g. 'Just to "
        "confirm, that's Chris Fernando — is that right?' If the guest says "
        "no, ask them to repeat the part that was wrong; do not guess again. "
        "If you ARE confident you heard the name clearly, do NOT add a "
        "confirmation step — proceed straight to the mobile number as usual. "
        "NEVER ask the guest to spell their name out letter by letter — "
        "spelled letters (e.g. B/P/V/D/E/G, M/N) are harder to hear "
        "accurately over a phone line than the name spoken naturally, so "
        "spelling makes the capture less reliable, not more.\n"
