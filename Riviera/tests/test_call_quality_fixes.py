...
def test_failsafe_kickoff_exists_and_is_directive():
    ...
    # Must not make Riya re-greet — Twilio already spoke the apology.
...
# ---------------------------------------------------------------------------
# #121 — ConversationRelay STT hints so Riya understands spoken digit
...
def test_english_conversationrelay_carries_digit_shorthand_hints():
    ...
    emits those words and Riya can expand them live. Without the hint,
