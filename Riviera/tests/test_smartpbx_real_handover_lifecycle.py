...
class QueueWebSocket:
    def __init__(self) -> None:
        self.headers = {"X-Riviera-SmartPBX-Token": "test-token"}
...
class CountingSession(RivieraSmartPBXSession):
...
async def test_real_acknowledged_transfer_stays_open_until_dialog_stop_and_posts_once(
    ...
    assert stt.audio == [], "post-ack carrier audio must not reach Riya STT"
