"""
test_voice_elevenlabs.py -- Local demo CLI for Riviera Resort (Riya), ElevenLabs TTS.
...
def build_system_prompt() -> str:
    ...
    return (
        ...
        f"Riviera Resort, Sri Lanka. The group operates two "
        ...
        "English: Good morning! Thank you for calling Riviera Resort. "
        "I'm Riya, lovely to have you with us! How may I help you today?\n"
        "Sinhala: Ayubowan! Riviera Resort walata obawa sadarayen "
        "piligannawa. Mama Riya, obata kohomada udaw karanne?\n"
        "Tamil: வணக்கம்! Riviera Resort-க்கு அழைத்தமைக்கு நன்றி. "
        "நான் Riya, உங்களுக்கு எப்படி உதவலாம்?\n"
    )
...
def main() -> None:
    ...
    print("=" * 60)
    print("  Riviera Resort Voice Agent (Riya) -- ElevenLabs Demo")
    if tts_enabled:
    ...
    while True:
        ...
        while tool_rounds < MAX_TOOL_ROUNDS:
            ...
            print("Riya: I'm having trouble completing that request. Could you try again?")
