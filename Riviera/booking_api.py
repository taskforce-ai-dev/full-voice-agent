"""booking_api.py -- thin shim mapping legacy Riya tool contract to yanolja_service.
...
Riviera Resort is a SINGLE property with five distinct room types, so
...
value resolves to "Riviera Resort". The parameter is retained so a second property
...
async def check_availability(
    ...
    guest_phone: str = "",
    guest_email: str = "",
    property_name: str = "",   # "Riviera Resort" (single property; may be empty)
) -> dict[str, Any]:
