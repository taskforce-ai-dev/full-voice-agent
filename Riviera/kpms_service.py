...
# Every name Riya may speak, across both properties.
RIVIERA_VOCAB: tuple[str, ...] = tuple(ROOM_TYPE_PROPERTY)
...
def _resolve_room_request(room_type: str, property_name: str = "") -> tuple[str, str]:
    ...
    pool = ROOM_TYPES_BY_PROPERTY[prop] if prop else RIVIERA_VOCAB
    candidates = [
...
def _display_name_for_type(type_id: str, pms_name: str = "") -> str:
    """Map a typeId to the canonical Riya-vocab display name.
    ...
    return _riviera_vocab_name(pms_name)
