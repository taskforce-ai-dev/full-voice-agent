"""
media_stream_server.py — Multilingual Riya server using Twilio Media Streams.
...
WELCOME_GREETING = "Welcome to Riviera Resort! How may I help you today?"
...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        f"Riviera Resort on Sri Lanka's Southern Coast. The group has "
...
class MediaStreamSession:
    ...
    def _on_stt_result(self, transcript: str):
        ...
        if self._is_speaking:
            # Riya is speaking — this is likely telephony echo, not the user.
...
app = FastAPI(
    title="Riya — Media Streams (Multilingual)",
    version="2.0.0",
    lifespan=lifespan,
)
