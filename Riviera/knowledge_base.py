...
COLLECTION_NAME: str = "riviera_kb"
...
# easily crowded out, and Riya answers "I don't have that rate". 8 gives good
...
def reload_kb_from_content(content: str, filename: str = "riviera_info.txt") -> bool:
